...
<head>
    ...
    <link rel="icon" href="#">
    <title>Home || Online Food Ordering Chain - Online Restaurent</title>
...
<body class="home">
    ...
    <header id="header" class="header-scroll top-header headrom">
        <nav class="navbar navbar-dark">
            <div class="container">
                ...
                <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/navlogos.png" alt=""
                        width="18%"> </a>
    ...
    <section class="hero bg-image" data-image-src="images/img/bgimg.jpeg">
        <div class="hero-inner">
            <div class="container text-center hero-text font-white">
                <h1>Dine at Home or Pickup</h1>
                ...
                <div class="steps">
                    <div class="step-item step1">
                        ...
                        <h4><span style="color:white;">1. </span>Select Dining Spot</h4>
                    </div>
                    ...
                    <div class="step-item step2">
                        ...
                        <h4><span style="color:white;">2. </span>Request a meal</h4>
                    </div>
                    ...
                    <div class="step-item step3">
                        ...
                        <h4><span style="color:white;">3. </span>Pickup or doorstep delivery</h4>
                    </div>
    ...
    <section class="popular">
        <div class="container">
            <div class="title text-xs-center m-b-30">
                <h2>Featured Dishes of the Month:Delightful Culinary Inspirations</h2>
                <p class="lead">Craving Your Favorites? Here’s How to Quickly Order Your Top Picks from This Month’s
                    Favorite Dishes</p>
            </div>
            <div class="row">
                <?php
                ...
                <div class="row how-it-works-solution">
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                        <div class="how-it-works-wrap">
                            <div class="step step-1">
                                ...
                                <h3>Find Your Dining Experience</h3>
                                <p>Explore a wide selection of delivery menus from top restaurants online.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                        <div class="step step-2">
                            ...
                            <h3>Decide on a dish</h3>
                            <p>Enjoy a wide selection of delivery restaurants just a click away.</p>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                        <div class="step step-3">
                            ...
                            <h3>Eat in or grab to-go</h3>
                            <p>"Have your meal delivered to your door and savor every bite!"</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="title-block pull-left">
                        <h4>Discover Our Popular Eateries</h4>
                    </div>
                </div>
                <div class="col-sm-8">
